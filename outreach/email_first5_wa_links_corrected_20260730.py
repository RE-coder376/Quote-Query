...
PACKAGE = HERE / "FIRST5_WA_LINKS_CORRECTED_20260730.md"
...
subject = "Quote Querry corrected first 5 wa.me links"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry corrected first 5 wa.me links</h2>"
