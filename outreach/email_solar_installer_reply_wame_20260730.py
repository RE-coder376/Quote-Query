...
PACKAGE = Path(r"C:\Users\User\Documents\Projects\Quote Querry\outreach\SOLAR_INSTALLER_REPLY_WAME_20260730.md")
...
subject = "Quote Querry Solar Installer follow-up wa.me"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry Solar Installer follow-up wa.me</h2>"
