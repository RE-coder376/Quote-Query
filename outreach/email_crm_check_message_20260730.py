...
PACKAGE = Path(r"C:\Users\User\Documents\Projects\Quote Querry\outreach\CRM_CHECK_MESSAGE_20260730.md")
...
subject = "Quote Querry CRM check message"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry CRM check message</h2>"
