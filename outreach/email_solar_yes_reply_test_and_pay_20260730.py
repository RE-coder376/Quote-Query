...
PACKAGE = Path(r"C:\Users\User\Documents\Projects\Quote Querry\outreach\SOLAR_YES_REPLY_TEST_AND_PAY_20260730.md")
...
subject = "Quote Querry solar yes-reply follow-up with test and pay"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry solar yes-reply follow-up with test and pay</h2>"
