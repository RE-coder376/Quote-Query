...
PACKAGE = HERE / "NEXT5_PREFILLED_WAME_MSG1_20260730.md"
...
subject = "Quote Querry next 5 prefilled wa.me links"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry next 5 prefilled wa.me links</h2>"
