...
PACKAGE = HERE / "FIRST5_WA_LINKS_20260730.md"
...
subject = "Quote Querry first 5 outreach wa.me links"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Quote Querry first 5 outreach wa.me links</h2>"
