...
PACKAGE = Path(r"C:\Users\User\Documents\Projects\Quote Querry\outreach\DEMO_FOLLOWUP_WAME_20260810.md")
...
subject = "QuoteRadar demo follow-up wa.me links - send Mon 10 Aug ~9-10am UAE"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>QuoteRadar demo follow-up</h2>"
    "<p style='margin-top:0;color:#666'>Send Monday 10 Aug, ~9-10am UAE (10-11am PKT). "
    "Tap a link on your phone to open the chat with the message ready.</p>"
