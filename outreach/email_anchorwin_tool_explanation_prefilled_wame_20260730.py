...
PACKAGE = HERE / "ANCHORWIN_TOOL_EXPLANATION_PREFILLED_WAME_20260730.md"
...
subject = "Anchorwin tool explanation prefilled wa.me link"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>Anchorwin tool explanation prefilled wa.me link</h2>"
