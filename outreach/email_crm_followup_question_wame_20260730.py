...
PACKAGE = HERE / "CRM_FOLLOWUP_QUESTION_WAME_20260730.md"
...
subject = "CRM follow-up question for Quote Querry leads"
html_body = (
    "<div style='font-family:Arial,sans-serif;line-height:1.6;max-width:820px;color:#222'>"
    "<h2 style='margin-bottom:6px'>CRM follow-up question for Quote Querry leads</h2>"
